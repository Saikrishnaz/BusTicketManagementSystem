...
Public Class JourneyDetailsAdd
    ...
    Private Sub ClearAllRegisterBusControls()
        ...
        Dim controlsToClear() As Control = {Txt_Departure, TextBox2, Txt_SourceLocation, Txt_Destination, Txt_ArrivalTime, Txt_JourneyName}
        For Each control As Control In controlsToClear
            control.Text = String.Empty
        Next
        Txt_BusName.SelectedIndex = -1
    End Sub
    ...
    Private Sub Guna2GradientButton1_Click(sender As Object, e As EventArgs) Handles Guna2GradientButton1.Click
        ...
        Try
            ...
            Using cmd As New SqlCommand(query, con)
                ...
                cmd.Parameters.AddWithValue("@BusName", If(Txt_BusName.SelectedIndex <> -1, Txt_BusName.SelectedValue.ToString(), DBNull.Value))
